        ...
        <div class="wrap">
            ...
            <div class="db-import-export">
                ...
                <p style="margin-top:20px;">
                    ✳️ Hromadný import POI je nyní dostupný pouze přes CLI / skripty v pluginu
                    (<code>scripts/import-csv-production.sh</code>). Tím se citlivá hesla drží mimo
                    WordPress administraci. Pokud potřebujete spustit import, použijte příkazové nástroje.
                </p>
            </div>
