  ...
  class SmartLoadingManager {
        ...
        const iv = setInterval(() => {
          ...
          if (attach() || tries > 50) { // ~5s
            ...
            if (!document.getElementById('db-manual-load-container')) {
              ...
              // Použít stejné hodnoty jako v CSS (.db-manual-load-container): bottom:56px, right:16px, z-index:650
              this.manualLoadButton.style.cssText = 'position:fixed;bottom:56px;right:16px;left:auto;transform:none;z-index:650;display:none;';
    ...
    async loadNewAreaData() {
      ...
      try {
        ...
        // Watcher automaticky zobrazí/skryje tlačítko podle toho, zda jsme mimo načtenou oblast
      }
    }
  }
